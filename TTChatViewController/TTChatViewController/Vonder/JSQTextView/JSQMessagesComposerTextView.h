...
typedef void (^TextViewHeightChangeBlock)(CGFloat height);
typedef void (^TextShouldBeginEditing)();
typedef void (^TextShouldReturnBlock)(UITextView * _Nonnull ,NSString * _Nullable);
...
@property (copy, nonatomic, nullable) TextViewHeightChangeBlock heightChangeBlock;
@property (copy, nonatomic, nullable) TextShouldBeginEditing textShouldBeginEditing;
@property (copy, nonatomic, nullable) TextShouldReturnBlock textShouldReturnBlock;
